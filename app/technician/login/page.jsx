...
export default function TechnicianLoginPage() {
  ...
  const { signIn, supabaseReady } = useTechnicianAuth();
    ...
    <div className="grid min-h-screen place-items-center bg-[#141414] p-6">
      <div className="w-full max-w-[400px] rounded-2xl bg-white p-9">
        <div className="mb-8 text-center">
          ...
          />
          <h1 className="text-[19px] font-extrabold text-ink">Technician Portal</h1>
          <p className="mt-1 text-[13.5px] text-body">Sign in to see your jobs</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            <div className="mb-1.5 flex items-center justify-between">
              <label className="block text-[13.5px] font-semibold text-ink">Password</label>
              <Link href="/forgot-password" className="text-[12.5px] font-semibold text-yellow-dark hover:underline">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="mt-6 text-center text-[12.5px] text-body">Access restricted to House Electric technicians. Contact admin for login access.</p>
      </div>
    </div>
  );
}
