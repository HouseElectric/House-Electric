...
export async function startPayment({ type, invoiceId, planId, quotationId, renewFromId, name, email, contact, description }) {
  const {
    data: { session },
  ...
  const orderRes = await fetch("/api/payments/create-order", {
    ...
    body: JSON.stringify({ type, invoiceId, planId, quotationId }),
  });
